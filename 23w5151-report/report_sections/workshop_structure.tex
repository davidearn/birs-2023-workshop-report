...
Special sessions included an introduction to the Historic Disease Data Portal (\Cref{sec:iidda}), a discussion about challenges in infectious disease surveillance across Canada (\Cref{sec:surv-disc}), and a workshop on the \macpan modelling software (\Cref{sec:macpan}).
